...
('Chelsea', 'Stamford Bridge', 'Club de football londonien de Premier League', '1905-03-10', 2, "Stamford Bridge, résidence du Chelsea FC, se dresse avec élégance à Londres. Avec une capacité de plus de 40 000 sièges, ce stade empreint de tradition est le lieu où les Blues de Chelsea forgent leur histoire. L'atmosphère vibrante de Stamford Bridge fait de chaque match une aventure captivante.", "ressources/PhotoJoueur/Chelsea/Stade.jpg" ,"Mauricio Pochettino", "ressources/PhotoJoueur/Chelsea/Entraineur.jpg", '#000c8a',"essources/FondEcranEquipe/Chealsea.png"),
