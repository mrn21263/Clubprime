                ...
                <div class="ranked">
                    <?php if (isset($classementData[2])) : ?>
                        <a href="./vue/vueclub.php?id=<?php echo $classementData[2]['id']; ?>">
                            <div class="general">
                                <img src="data:image/jpeg;base64,<?php echo base64_encode($classementData[2]['logo']); ?>" alt="logo du premier" width="50%">
                                <div class="deux">
                    ...
                    <?php if (isset($classementData[1])) : ?>
                        <a href="./vue/vueclub.php?id=<?php echo $classementData[1]['id']; ?>">
                            <div class="general3">
                                <img src="data:image/jpeg;base64,<?php echo base64_encode($classementData[1]['logo']); ?>" alt="logo du troisième" width="70%">
                                <div class="trois">
    ...
    <?php foreach ($clubs as $club) : ?>
        <a href="./vue/vueclub.php?id=<?php echo $club['id']; ?>">
            <div class="place<?php echo $club['classement']; ?>">
